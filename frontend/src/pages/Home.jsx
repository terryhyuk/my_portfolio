...
export default function Home() {
    ...
    const fetchData = () => {
        ...
        fetch('https://my-portfolio-ganv.onrender.com/user/about-web')
            ...
            .then((data) => {
                ...
                // Safely parse JSON or fallback to legacy plain text into whyBuilt
                try {
                    const parsed = data.about_this_web ? JSON.parse(data.about_this_web) : {};
                    setEditAboutData({
                        whyBuilt: parsed.whyBuilt || data.about_this_web || '',
    ...
    // Handle saving About This Web section (Stringifies the object before sending)
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '24px', fontFamily: 'sans-serif', background: '#fafbfc', minHeight: '100vh' }}>
            ...
            <SystemStructureSection 
                ...
                editAboutData={editAboutData}
                setEditAboutData={setEditAboutData}
                uploading={uploading}
