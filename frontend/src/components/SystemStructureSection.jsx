...
export default function SystemStructureSection({
    ...
    // Split skill string into an array for preview
            ...
            {isEditingAboutWeb ? (
                ...
                <div style={{ background: '#fafbfc', border: '1px solid #00875a', borderRadius: '12px', padding: '24px' }}>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{ fontSize: '12px', fontWeight: '600', display: 'block', marginBottom: '6px', color: '#444' }}>Skills (Comma-separated)</label>
                        <input 
                            type="text"
                            value={editAboutData.skill || ''}
                            onChange={(e) => handleChange('skill', e.target.value)}
                            placeholder="e.g. React, FastAPI, PostgreSQL"
                            style={{ width: '100%', padding: '10px', fontSize: '13px', borderRadius: '6px', border: '1px solid #ddd', boxSizing: 'border-box' }}
                        />
                    </div>
