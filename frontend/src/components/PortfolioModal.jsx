...
//             // 1. If a new image file is selected, upload it to FastAPI backend static storage
//             if (imageFile) {
...
//                 imageUrl = uploadData.url; // Get backend static image URL
//             }

//             // 2. Save portfolio data (POST or PUT)
//             const url = isEditMode
//                 ? `http://127.0.0.1:8000/portfolio/${editData.number}`
//                 : 'http://127.0.0.1:8000/portfolio/';
